...
if (isset($_SERVER['REQUEST_URI']) && strpos($_SERVER['REQUEST_URI'], '/api/') !== false) {
    // This is an API call, don't render HTML
    // The .htaccess will handle routing to API files
    exit();
...
$query = $connection->query("SELECT * FROM deductions");
  ...
  <body>
    ...
    <div class="container">
      ...
      <footer class="footer">
        ...
        <p align="center">Developed By JEASA</p>
      </footer>
