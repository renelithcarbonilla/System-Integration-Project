...
// Ensure user is logged in (Example: Admin or specific user roles check)
...
$sitename = isset($sitename) ? $sitename : 'Hospital Management System';
...
<head>
    <meta charset="utf-8">
    <title>All Employees | <?php echo $sitename; ?></title>
